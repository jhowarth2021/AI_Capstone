...
def predict():
    ...
    ## extract the fields
    print(request.json)
    country = request.json['query']['country']
    year = request.json['query']['year']
    month = request.json['query']['month']
    day = request.json['query']['day']
    ...
    _result = model_predict(country,year,month,day, all_models = model, test=test)
    result = {}
